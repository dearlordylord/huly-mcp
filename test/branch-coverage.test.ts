  ...
  it.effect("skips employee when personUuid is undefined", () =>
    Effect.gen(function*() {
      const dm: HulyDirectMessage = {
        ...
        private: true,
        archived: false,
        members: ["00000000-0000-4000-8000-000000000001" as HulyAccountUuid],
        messages: 1,
        modifiedBy: "user-1" as PersonId,
        modifiedOn: 0,
        createdBy: "user-1" as PersonId,
  ...
  it.effect("resolves employees WITH personUuid but skips those WITHOUT", () =>
    Effect.gen(function*() {
      const dm: HulyDirectMessage = {
        ...
        archived: false,
        members: [
          "00000000-0000-4000-8000-000000000001" as HulyAccountUuid,
          "00000000-0000-4000-8000-000000000002" as HulyAccountUuid
        ],
        messages: 1,
        modifiedBy: "user-1" as PersonId,
        modifiedOn: 0,
