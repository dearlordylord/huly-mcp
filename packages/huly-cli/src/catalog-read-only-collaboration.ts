...
export const collaborationReadOnlyCliCommandCatalog = {
  ...
  get_approval_request: { path: ["approvals", "get"], positional: ["request"], description: "Get Approval Request" },
  get_board: { path: ["boards", "get"], positional: ["board"], description: "Get Board" },
  get_board_card: { path: ["boards", "cards", "get"], positional: ["board", "card"], description: "Get Board Card" },
  ...
  get_channel: { path: ["channels", "get"], positional: ["channel"], description: "Get Channel" },
  ...
  get_message_template: { path: ["templates", "get"], positional: ["template"], description: "Get Message Template" },
  get_notification: { path: ["notifications", "get"], positional: ["notificationId"], description: "Get Notification" },
  ...
  list_activity: { path: ["activity", "list"], positional: [], description: "List Activity" },
  ...
  list_approval_requests: { path: ["approvals", "list"], positional: [], description: "List Approval Requests" },
  list_attached_tags: { path: ["tags", "attached", "list"], positional: [], description: "List Attached Tags" },
  list_board_card_labels: {
    path: ["boards", "cards", "labels", "list"],
    positional: ["board", "card"],
    description: "List Board Card Labels"
  },
  list_board_cards: { path: ["boards", "cards", "list"], positional: ["board"], description: "List Board Cards" },
  list_board_labels: { path: ["boards", "labels", "list"], positional: [], description: "List Board Labels" },
  ...
  list_board_viewlets: { path: ["boards", "viewlets", "list"], positional: [], description: "List Board Viewlets" },
  list_boards: { path: ["boards", "list"], positional: [], description: "List Boards" },
  ...
  list_channels: { path: ["channels", "list"], positional: [], description: "List Channels" },
  ...
  list_employees: { path: ["contacts", "employees", "list"], positional: [], description: "List Employees" },
  ...
  list_workbench_applications: {
    path: ["workbench", "applications", "list"],
    positional: [],
    description: "List Workbench Applications"
  },
  ...
  list_message_templates: { path: ["templates", "list"], positional: [], description: "List Message Templates" },
  ...
  list_notifications: { path: ["notifications", "list"], positional: [], description: "List Notifications" },
  ...
  list_persons: { path: ["contacts", "persons", "list"], positional: [], description: "List Persons" },
  list_reactions: { path: ["activity", "reactions", "list"], positional: ["messageId"], description: "List Reactions" },
  list_saved_messages: { path: ["activity", "saved", "list"], positional: [], description: "List Saved Messages" },
  list_space_permissions: {
    path: ["spaces", "permissions", "list"],
    positional: [],
    description: "List Space Permissions"
  },
  list_space_types: { path: ["spaces", "types", "list"], positional: [], description: "List Space Types" },
  list_spaces: { path: ["spaces", "list"], positional: [], description: "List Spaces" },
  list_tag_categories: { path: ["tags", "categories", "list"], positional: [], description: "List Tag Categories" },
  list_tags: { path: ["tags", "list"], positional: ["targetClass"], description: "List Tags" },
  list_thread_replies: {
