...
export const businessMutationCliCommandCatalogA = {
  ...
  delete_card: {
    ...
    behavior: { confirmation: { type: "requires-yes", message: "cards delete requires --yes." } }
  },
  delete_card_comment: {
    path: ["cards", "comments", "delete"],
    positional: ["cardSpace", "card", "commentId"],
    description: "Delete Card Comment",
    behavior: { confirmation: { type: "requires-yes", message: "cards comments delete requires --yes." } }
  },
  delete_drive: {
    path: ["drive", "delete"],
    positional: ["drive"],
    description: "Delete Drive",
    behavior: { confirmation: { type: "requires-yes", message: "drive delete requires --yes." } }
  },
  delete_drive_file_comment: {
    path: ["drive", "files", "comments", "delete"],
    positional: ["drive", "commentId"],
    description: "Delete Drive File Comment",
    behavior: { confirmation: { type: "requires-yes", message: "drive files comments delete requires --yes." } }
  },
  delete_drive_item: {
  ...
  delete_event: {
    ...
    behavior: { confirmation: { type: "requires-yes", message: "calendar events delete requires --yes." } }
  },
  delete_inventory_category: {
    path: ["inventory", "category", "delete"],
    positional: ["category"],
    description: "Delete Inventory Category",
    behavior: { confirmation: { type: "requires-yes", message: "inventory category delete requires --yes." } }
  },
  delete_inventory_product: {
    path: ["inventory", "product", "delete"],
    positional: ["product"],
    description: "Delete Inventory Product",
    behavior: { confirmation: { type: "requires-yes", message: "inventory product delete requires --yes." } }
  },
  delete_inventory_product_attachment: {
    ...
    behavior: { confirmation: { type: "requires-yes", message: "inventory product attachment delete requires --yes." } }
  },
  delete_inventory_product_comment: {
    ...
    behavior: { confirmation: { type: "requires-yes", message: "inventory product comment delete requires --yes." } }
  },
  delete_inventory_product_photo: {
    ...
    behavior: { confirmation: { type: "requires-yes", message: "inventory product photo delete requires --yes." } }
  },
  delete_inventory_variant: {
    path: ["inventory", "variant", "delete"],
    positional: ["variant"],
    description: "Delete Inventory Variant",
    behavior: { confirmation: { type: "requires-yes", message: "inventory variant delete requires --yes." } }
  },
  delete_recruiting_applicant: {
    path: ["recruiting", "applicant", "delete"],
    positional: ["applicant"],
    description: "Delete Recruiting Applicant",
    behavior: { confirmation: { type: "requires-yes", message: "recruiting applicant delete requires --yes." } }
  },
  delete_recruiting_attachment: {
    ...
    behavior: { confirmation: { type: "requires-yes", message: "recruiting attachment delete requires --yes." } }
  },
  delete_recruiting_comment: {
    path: ["recruiting", "comment", "delete"],
    positional: ["target", "commentId"],
    description: "Delete Recruiting Comment",
    behavior: { confirmation: { type: "requires-yes", message: "recruiting comment delete requires --yes." } }
  },
  delete_recruiting_opinion: {
    path: ["recruiting", "opinion", "delete"],
    positional: ["opinion"],
    description: "Delete Recruiting Opinion",
    behavior: { confirmation: { type: "requires-yes", message: "recruiting opinion delete requires --yes." } }
  },
  delete_recruiting_review: {
    path: ["recruiting", "review", "delete"],
    positional: ["review"],
    description: "Delete Recruiting Review",
    behavior: { confirmation: { type: "requires-yes", message: "recruiting review delete requires --yes." } }
  },
  delete_schedule: {
    path: ["calendar", "schedules", "delete"],
    positional: ["scheduleId"],
    description: "Delete Schedule",
    behavior: { confirmation: { type: "requires-yes", message: "calendar schedules delete requires --yes." } }
  },
  delete_test_case: {
    path: ["tests", "case", "delete"],
    positional: ["project", "testCase"],
    description: "Delete Test Case",
    behavior: { confirmation: { type: "requires-yes", message: "tests case delete requires --yes." } }
  }
