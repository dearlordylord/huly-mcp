...
export const businessReadOnlyCliCommandCatalogA = {
  get_card: { path: ["cards", "get"], positional: ["cardSpace", "card"], description: "Get Card" },
  get_detailed_time_report: {
    path: ["time", "reports", "detailed", "get"],
    positional: ["project"],
    description: "Get Detailed Time Report"
  },
  get_drive: { path: ["drive", "get"], positional: ["drive"], description: "Get Drive" },
  get_drive_item: { path: ["drive", "items", "get"], positional: ["drive"], description: "Get Drive Item" },
  get_event: { path: ["calendar", "events", "get"], positional: ["eventId"], description: "Get Event" },
  ...
  get_office: { path: ["office", "offices", "get"], positional: ["roomId"], description: "Get Office" },
  get_office_floor: { path: ["office", "floors", "get"], positional: ["floorId"], description: "Get Office Floor" },
  get_office_room: { path: ["office", "rooms", "get"], positional: ["roomId"], description: "Get Office Room" },
  ...
  get_schedule: { path: ["calendar", "schedules", "get"], positional: ["scheduleId"], description: "Get Schedule" },
  get_test_case: { path: ["tests", "case", "get"], positional: ["project", "testCase"], description: "Get Test Case" },
  get_test_plan: { path: ["tests", "plan", "get"], positional: ["project", "plan"], description: "Get Test Plan" },
  get_test_result: {
    path: ["tests", "result", "get"],
    positional: ["project", "result"],
    description: "Get Test Result"
  },
  get_test_run: { path: ["tests", "run", "get"], positional: ["project", "run"], description: "Get Test Run" },
  get_test_suite: { path: ["tests", "suite", "get"], positional: ["project", "suite"], description: "Get Test Suite" },
  get_time_report: {
    path: ["time", "reports", "get"],
    positional: ["project", "identifier"],
    description: "Get Time Report"
  },
  get_todo: { path: ["planner", "todos", "get"], positional: ["locator"], description: "Get Todo" },
  ...
  list_cards: { path: ["cards", "list"], positional: ["cardSpace"], description: "List Cards" },
  list_card_versions: {
  ...
  list_drive_items: { path: ["drive", "items", "list"], positional: ["drive"], description: "List Drive Items" },
  list_drives: { path: ["drive", "list"], positional: [], description: "List Drives" },
