...
export const collaborationMutationCliCommandCatalogB = {
  ...
  remove_board_card_label: {
    ...
    behavior: { confirmation: { type: "requires-yes", message: "boards cards labels remove requires --yes." } }
  },
  remove_channel_members: {
    path: ["channels", "members", "remove"],
    positional: ["channel", "members"],
    description: "Remove Channel Members",
    behavior: { confirmation: { type: "requires-yes", message: "channels members remove requires --yes." } }
  },
  remove_organization_channel: {
    ...
    behavior: {
      confirmation: { type: "requires-yes", message: "contacts organizations channels remove requires --yes." }
    }
  },
  remove_organization_member: {
    ...
    behavior: {
      confirmation: { type: "requires-yes", message: "contacts organizations members remove requires --yes." }
    }
  },
  remove_person_channel: {
    ...
    behavior: { confirmation: { type: "requires-yes", message: "contacts persons channels remove requires --yes." } }
  },
  remove_reaction: {
  ...
  unarchive_channel: { path: ["channels", "unarchive"], positional: ["channel"], description: "Unarchive Channel" },
  ...
  update_channel: { path: ["channels", "update"], positional: ["channel"], description: "Update Channel" },
