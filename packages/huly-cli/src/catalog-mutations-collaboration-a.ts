...
export const collaborationMutationCliCommandCatalogA = {
  ...
  archive_board: { path: ["boards", "archive"], positional: ["board"], description: "Archive Board" },
  archive_board_card: {
    path: ["boards", "cards", "archive"],
    positional: ["board", "card"],
    description: "Archive Board Card"
  },
  archive_channel: { path: ["channels", "archive"], positional: ["channel"], description: "Archive Channel" },
  ...
  cancel_approval_request: {
    ...
    behavior: { confirmation: { type: "requires-yes", message: "approvals cancel requires --yes." } }
  },
  create_board: {
    path: ["boards", "create"],
    positional: ["name"],
  ...
  create_channel: { path: ["channels", "create"], positional: ["name"], description: "Create Channel" },
  ...
  delete_activity_reply: {
    ...
    behavior: { confirmation: { type: "requires-yes", message: "activity replies delete requires --yes." } }
  },
  delete_board_card: {
    path: ["boards", "cards", "delete"],
    positional: ["board", "card"],
    description: "Delete Board Card",
    behavior: { confirmation: { type: "requires-yes", message: "boards cards delete requires --yes." } }
  },
  delete_board_label: {
    path: ["boards", "labels", "delete"],
    positional: ["label"],
    description: "Delete Board Label",
    behavior: { confirmation: { type: "requires-yes", message: "boards labels delete requires --yes." } }
  },
  delete_channel: {
    path: ["channels", "delete"],
    positional: ["channel"],
    description: "Delete Channel",
    behavior: { confirmation: { type: "requires-yes", message: "channels delete requires --yes." } }
  },
  delete_chat_message_attachment: {
    ...
    behavior: {
      confirmation: { type: "requires-yes", message: "channels messages attachments delete requires --yes." }
    }
  },
  delete_notification: {
    ...
    behavior: { confirmation: { type: "requires-yes", message: "notifications delete requires --yes." } }
  },
  delete_organization: {
    path: ["contacts", "organizations", "delete"],
    positional: ["identifier"],
    description: "Delete Organization",
    behavior: { confirmation: { type: "requires-yes", message: "contacts organizations delete requires --yes." } }
  },
  delete_person: {
    path: ["contacts", "persons", "delete"],
    positional: ["personId"],
    description: "Delete Person",
    behavior: { confirmation: { type: "requires-yes", message: "contacts persons delete requires --yes." } }
  },
  delete_tag: {
    path: ["tags", "delete"],
    positional: ["targetClass", "tag"],
    description: "Delete Tag",
    behavior: { confirmation: { type: "requires-yes", message: "tags delete requires --yes." } }
  },
  delete_tag_category: {
    path: ["tags", "categories", "delete"],
    positional: ["category"],
    description: "Delete Tag Category",
    behavior: { confirmation: { type: "requires-yes", message: "tags categories delete requires --yes." } }
  },
  ...
  join_channel: { path: ["channels", "join"], positional: ["channel"], description: "Join Channel" },
  leave_channel: { path: ["channels", "leave"], positional: ["channel"], description: "Leave Channel" },
