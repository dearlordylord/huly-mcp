...
import {
  ...
  AddPersonChannelResultSchema,
  ListContactChannelProvidersResultSchema,
  ListOrganizationChannelsResultSchema,
  ListPersonChannelsResultSchema,
  RemoveOrganizationChannelResultSchema,
  RemovePersonChannelResultSchema,
  UpdateOrganizationChannelResultSchema,
  UpdatePersonChannelResultSchema
} from "../../domain/schemas/contact-channels.js"
import {
  AddOrganizationMemberResultSchema,
  CreateOrganizationResultSchema,
  DeleteOrganizationResultSchema,
  GetOrganizationResultSchema,
  ListOrganizationMembersResultSchema,
  ListOrganizationsResultSchema,
  ListPersonOrganizationsResultSchema,
  MakeOrganizationCustomerResultSchema,
  RemoveOrganizationMemberResultSchema,
  ...
  defineTool(
    {
      ...
      resultSchema: ListPersonsResultSchema
    },
    parseListPersonsParams,
    listPersons
  ),
  defineTool(
    {
      ...
      resultSchema: GetPersonResultSchema
    },
    parseGetPersonParams,
    getPerson
  ),
  defineTool(
    {
      ...
      resultSchema: CreatePersonResultSchema
    },
    parseCreatePersonParams,
    createPerson
  ),
  defineTool(
    {
      ...
      resultSchema: UpdatePersonResultSchema
    },
    parseUpdatePersonParams,
    updatePerson
  ),
  defineTool(
    {
      ...
      resultSchema: DeletePersonResultSchema
    },
    parseDeletePersonParams,
    deletePerson
  ),
  ...
  defineTool(
    {
      ...
      resultSchema: ListContactChannelProvidersResultSchema
    },
    parseListContactChannelProvidersParams,
    listContactChannelProviders
  ),
  defineTool(
    {
      ...
      resultSchema: ListPersonChannelsResultSchema
    },
    parseListPersonChannelsParams,
    listPersonChannels
  ),
  defineTool(
    {
      ...
      resultSchema: AddPersonChannelResultSchema
    },
    parseAddPersonChannelParams,
    addPersonChannel
  ),
  defineTool(
    {
      ...
      resultSchema: UpdatePersonChannelResultSchema
    },
    parseUpdatePersonChannelParams,
    updatePersonChannel
  ),
  defineTool(
    {
      ...
      resultSchema: RemovePersonChannelResultSchema
    },
    parseRemovePersonChannelParams,
    removePersonChannel
  ),
  defineTool(
    {
      ...
      resultSchema: ListOrganizationsResultSchema
    },
    parseListOrganizationsParams,
    listOrganizations
  ),
  defineTool(
    {
      ...
      resultSchema: CreateOrganizationResultSchema
    },
    parseCreateOrganizationParams,
    createOrganization
  ),
  defineTool(
    {
      ...
      resultSchema: GetOrganizationResultSchema
    },
    parseGetOrganizationParams,
    getOrganization
  ),
  ...
  defineTool(
    {
      ...
      resultSchema: DeleteOrganizationResultSchema
    },
    parseDeleteOrganizationParams,
    deleteOrganization
  ),
  defineTool(
    {
      ...
      category: CATEGORY,
      inputSchema: getOrganizationParamsJsonSchema,
      resultSchema: MakeOrganizationCustomerResultSchema
    },
    parseGetOrganizationParams,
    makeOrganizationCustomer
  ),
  defineTool(
    {
      ...
      resultSchema: AddOrganizationChannelResultSchema
    },
    parseAddOrganizationChannelParams,
    addOrganizationChannel
  ),
  defineTool(
    {
      ...
      resultSchema: ListOrganizationChannelsResultSchema
    },
    parseListOrganizationChannelsParams,
    listOrganizationChannels
  ),
  defineTool(
    {
      ...
      resultSchema: UpdateOrganizationChannelResultSchema
    },
    parseUpdateOrganizationChannelParams,
    updateOrganizationChannel
  ),
  defineTool(
    {
      ...
      resultSchema: RemoveOrganizationChannelResultSchema
    },
    parseRemoveOrganizationChannelParams,
    removeOrganizationChannel
  ),
  defineTool(
    {
      ...
      resultSchema: AddOrganizationMemberResultSchema
    },
    parseAddOrganizationMemberParams,
    addOrganizationMember
  ),
  defineTool(
    {
      ...
      resultSchema: ListOrganizationMembersResultSchema
    },
    parseListOrganizationMembersParams,
    listOrganizationMembers
  ),
  defineTool(
    {
      ...
      resultSchema: ListPersonOrganizationsResultSchema
    },
    parseListPersonOrganizationsParams,
    listPersonOrganizations
  ),
  defineTool(
    {
      ...
      resultSchema: RemoveOrganizationMemberResultSchema
    },
    parseRemoveOrganizationMemberParams,
    removeOrganizationMember
  )
