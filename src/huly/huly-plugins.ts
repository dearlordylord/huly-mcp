...
export const calendar = load("@hcengineering/calendar").default as typeof import("@hcengineering/calendar").default
export const cardPlugin = load("@hcengineering/card").default as typeof import("@hcengineering/card").default
