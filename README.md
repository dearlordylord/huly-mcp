...
| `delete_funnel` | Permanently delete an exact funnel only after it is archived and its lead, comment, and attachment impact is empty. Use get_funnel for preflight and archive_funnel first. Non-empty funnels are rejected. |
